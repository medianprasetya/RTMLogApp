...
// class ProfileDetailController extends GetxController with StateMixin<ProfileDetail> {
//   var deviceID = Get.arguments;
...
//         final Map<String, dynamic> deviceData = responseData['data']['deviceData'];
...
//         change(data, status: RxStatus.success());
//       } else {
//         throw Exception('Gagal mengambil detail profil. Kode: ${response.statusCode}');
//       }
//     } catch (e) {
//       print('Terjadi kesalahan: $e');
//       change(null, status: RxStatus.error('Terjadi kesalahan: ${e.toString()}'));
//     }
//   }
// }
